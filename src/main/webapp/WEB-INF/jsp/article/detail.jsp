	...
	<table>
		...
		<tbody>
			...
			<tr>
				<th>좋아요</th>
				<td>
					<span class="article--like-point">${article.extra.likePoint}</span>
	
						<a href="#" onclick="callDoLike();">좋아요</a>
						<a href="#" onclick="callDoCancelLike();">좋아요취소</a>
				</td>
			</tr>
			<tr>
				<th>비고</th>
...
<c:if test="${isLogined}">
	<h2 class="con margin-top-30" style="margin-bottom: 20px;">댓글 작성</h2>
...
<h2 class="con margin-top-30" style="margin-bottom: 20px">댓글 리스트</h2>
		...
		<tbody>
			<c:forEach items="${articleReplies}" var="articleReply">
				<tr>
					...
					<td>
						<a href="./doDeleteReply?id=${articleReply.id}&redirectUrl=${requesturiQueryString}"
						onclick="if ( confirm('삭제하시겠습니까?') == false ) { return false; }">삭제</a>
						<a href="./modifyReply?id=${articleReply.id}&redirectUrl=${requesturiQueryString}">수정</a>
					</td> 
				</tr>
			</c:forEach>
		</tbody>
